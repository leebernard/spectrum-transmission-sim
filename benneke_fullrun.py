...
# define a new prior function, with only CH4
...
with Pool() as pool:
    for transit_data in noisey_transit_depth_h2o:
        ...
        sampler.run_nested()
        h2och4_results_h2otrue.append(sampler.results)

# again, for the ch4 case
h2och4_results_ch4true = []
with Pool() as pool:
    for transit_data in noisey_transit_depth_ch4:
...
logz_h2och4_h2otrue = np.array([result.logz[-1] for result in h2och4_results_h2otrue])

delta_logz_h2otrue = logz_h2o_h2otrue - logz_ch4_h2otrue
delta_logz_h2otrue_h2ovsmix = logz_h2och4_h2otrue - logz_h2o_h2otrue
delta_logz_h2otrue_ch4vsmix = logz_h2och4_h2otrue - logz_ch4_h2otrue
...
logz_h2och4_ch4true = np.array([result.logz[-1] for result in h2och4_results_ch4true])
